...
let s:darkPink         = { "gui": "#424a59", "cterm": "88"  }
...
let s:lightBlue        = { "gui": "#b0dff2", "cterm": "195" }
...
" Custom
let s:almostBlack      = { "gui": "#191f2c", "cterm": "233" }
let s:middleYellow     = { "gui": "#f2e3c9", "cterm": "149" }
let s:lightGreen       = { "gui": "#c4e8bb", "cterm": "157" }
let s:cyan             = { "gui": "#bbf9f8", "cterm": "800" }
let s:lightGrayBlue    = { "gui": "#545c62", "cterm": "800" }
let s:lavender         = { "gui": "#cea2e5", "cterm": "800" }
let s:brightBlue       = { "gui": "#bff9ff", "cterm": "800" }
let s:brightPink       = { "gui": "#f9bfff", "cterm": "800" }
...
call s:h("Visual",       { "fg": s:brightPink })
call s:h("IncSearch",    { "fg": s:lavender })
call s:h("Search",       { "fg": s:lavender })
...
call s:h("Identifier", { "fg": s:accent2 })
